        ...
        <div class="header-content">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu glass">
                    <li><a class="dropdown-item" href="Views/panelusuario.php"><span class="material-symbols-outlined lia"></span>Gestionar cuenta</a></li>
                    <li><a class="dropdown-item" href="Views/panelusuario.php"><span class="material-symbols-outlined">travel_explore</span>Historial de Reservación</a></li>
