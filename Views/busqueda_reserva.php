...
SELECT 
    ...
    SUM(DETALLE_PAGO.MONTO_TOTAL) AS MONTO_TOTAL,
    COUNT(DETALLE_RESERVACION.ID_DETALLE_RESERVACION) AS CANTIDAD_DE_HABITACIONES,
    GROUP_CONCAT(DISTINCT DETALLE_RESERVACION.FECHA_INICIO ORDER BY DETALLE_RESERVACION.FECHA_INICIO ASC SEPARATOR ', ') AS FECHAS_INICIO,
    GROUP_CONCAT(DISTINCT DETALLE_RESERVACION.FECHA_FIN ORDER BY DETALLE_RESERVACION.FECHA_FIN ASC SEPARATOR ', ') AS FECHAS_FIN
FROM 
    USUARIOS
INNER JOIN 
