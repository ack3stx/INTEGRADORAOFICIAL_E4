  ...
  <div class="container mt-5">
    ...
    <form action="" method="post">
        <div class="form-group">
            ...
            <input name="N_reservacion" type="number" class="form-control" id="nombre"
                placeholder="Por favor ingrese el número de la reservación.">
        </div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($N_reservacion)) {
        ...
        if (empty($tabla)) {
            echo "<p>No se encontro al huesped.</p>";
        } else {
            echo "
