...
JOIN 
    HABITACION ON HABITACION.ID_HABITACION = DETALLE_RESERVACION.HABITACION
JOIN 
    T_HABITACION ON T_HABITACION.ID_TIPO_HABITACION = HABITACION.TIPO_HABITACION
JOIN 
    HUESPED ON RESERVACION.HUESPED = HUESPED.ID_HUESPED
JOIN 
    PERSONA ON HUESPED.PERSONA_HUESPED = PERSONA.ID_PERSONA
WHERE 
    RESERVACION.ESTADO_RESERVACION = 'proceso'
