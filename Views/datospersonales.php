...
<body>
    ...
    <div class="container utt">
        ...
        <p id="mo">Este es el e-mail que usas para iniciar sesión y en el que recibes la confirmación de las reservas
        </p>
        <button style="margin-left: 90%;" id="editar3" type="button" class="btn lol"
            data-bs-toggle="button">Editar</button>
        ...
        <p id="ola">Indica tu número de teléfono</p>
        <button id="editar4" type="button" class="btn lol" data-bs-toggle="button">Editar</button>
        <!--LO QUE APARECE CUANDO LE DAS BOTON-->
        <div id="paradise">

            <input style="margin-left: 20%; margin-bottom: 10%;" type="tel" id="phone" placeholder="Escribe tu Número">
        ...
        <hr class="mb-4">
        <p>Dirección</p>
        <p id="omg">Añade tu dirección</p>
        <button id="editar5" type="button" class="btn lol" data-bs-toggle="button">Editar</button>
        <!--LO QUE APARECE CUANDO LE DAS CLICK AL BOTON-->
        <div id="noo" style="margin-left: 30%; ">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div>
                    <p>Dirección</p>
                    <input type="text" placeholder="Nombre de la calle y número">
                </div>
            </div>
        ...
        <div class="lg" style="margin-left: -80%; margin-top: -105%;">
        ...
        <script>
           ...
           /*BOTONES DE EDITAR*/
            ...
            document.getElementById('editar4').addEventListener('click', function mostrar() {


                document.getElementById('paradise').style.display = 'block';
                document.getElementById('editar4').style.display = 'none';
                document.getElementById('editar').disabled = true;
            ...
            document.getElementById('editar5').addEventListener('click', function mostrar() {


                document.getElementById('noo').style.display = 'block';
                document.getElementById('editar5').style.display = 'none';
                document.getElementById('editar').disabled = true;
