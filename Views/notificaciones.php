...
SELECT 
    ...
    USUARIOS.CORREO,
    DETALLE_RESERVACION.TIPO_HABITACION,
    COUNT(DETALLE_RESERVACION.ID_DETALLE_RESERVACION) AS CANTIDAD_HABITACIONES,
    (HABITACION.PRECIO_UNITARIO * COUNT(DETALLE_RESERVACION.ID_DETALLE_RESERVACION)) AS PRECIO_TOTAL_POR_TIPO,
    SUM(HABITACION.PRECIO_UNITARIO * COUNT(DETALLE_RESERVACION.ID_DETALLE_RESERVACION)) AS PRECIO_TOTAL_RESERVACION
FROM 
    DETALLE_PAGO
JOIN 
