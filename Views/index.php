...
<br><br><br><br>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active" data-bs-interval="10000">
        ...
        <div class="carousel-caption d-none d-md-block">
          ...
          <p>Reserva ya en nuestro Hotel.</p>
        </div>
      </div>
    ...
    <div class="HC container">
      <div class="row align-items-center">
          <div class="col-md-6 mb-4 mb-md-0">
              ...
              <a href="./nosotros.html" class="btn btn-custom">Conócenos</a>
          </div>
          <div class="col-md-6">
              <div class="image-container">
                  <img src="./imagenes/SILLONES.png" alt="Main Image">
                  <div class="image-overlay">
                      <img src="./imagenes/SILLONES.png" alt="Overlay Image">
                  </div>
              </div>
          </div>
      </div>
  ...
  <div class="HCON">
    <div class="HCG">
      ...
      <div class="gallery">
          <div class="imgBox" data-url="./nosotros.html">
              <h3>Sencilla</h3>
          </div>
          <div class="imgBox" data-url="./nosotros.html">
              <h3>Doble</h3>
    ...
    <div class="container my-faq-container">
      <div class="row">
          <div class="col text-center">
              <h1 class="my-faq-title">Preguntas frecuentes</h1>
          </div>
      </div>
...
<footer  style="background-color:  rgb(116, 13, 13);" class="text-white pt-5 pb-4 pl-0 pr-0 no-compañero">
  ...
  <div class="container text-center text-md-start">
      <div class="row text-center text-md-start">
          <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3 ai">
              <h2 class="text-left" style="color: white;">Contáctanos</h2>
              <hr class="mb-4">
              <p class="text-left">
                  <label style="color: white;"><i class="fa-solid fa-house"></i>&nbsp;&nbsp; Av. de la Cantera 8510, Colonia Las Misiones I, CP 31115, Torreón , México</label>
                  <br>
                  <label style="color: white;"><i class="fa-solid fa-envelope"></i>&nbsp;&nbsp;hotellagunainn@inn.com</label>
                  <br>
                  <label style="color: white;"><i class="fa-solid fa-phone"></i>&nbsp;&nbsp;+52 (614) 432-1500</label>
                  <br><br>
                  <p class="diplay">
                  <i class="fa-brands fa-instagram icono-si" style="color: white;"></i>
                  <i class="fa-brands fa-facebook icono-si diplay" style="color: white;"></i>
                  <i class="fa-brands fa-whatsapp icono-si" style="color: white;"></i>
                  </p>
              </p>
          </div>
      </div>
  ...
  <div class="container text-center text-md-start">
      <div class="row text-center text-md-start">
          <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3 ai">
              <h2 class="text-left" style="color: white;">Explora</h2>
              <hr class="mb-4">
              
                  <p class="pagina" style="color: white;">Inicio</p>
                  <br>
                  <p class="pagina" style="color: white;">Nosotros</p>
                  <br>
                  <p class="pagina" style="color: white;">Habitaciones</p>
                  <br>
                  <p class="pagina" style="color: white;">Amenidades</p>
                  <br>
          </div>
      </div>
  </div>
  <div class="container text-center text-md-start">
      <div class="row text-center text-md-start">
          <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3 ai">
              <h2 class="text-left" style="color: white;">Novedades</h2>
              <hr class="mb-4" style="color: white;">
                  <p style="color: white;">Recibe las últimas ofertas y promociones del Hotel Laguna Inn</p>
                  <br>
