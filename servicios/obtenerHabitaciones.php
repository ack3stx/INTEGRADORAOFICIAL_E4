<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['startDate']) && isset($_POST['endDate'])) {
            ...
            $gentedoble = "SELECT T_HABITACION.CANTIDAD_MAX_ADULTOS as adultos, T_HABITACION.CANTIDAD_MAX_NINOS as niños
            from T_HABITACION
            where T_HABITACION.NOMBRE='Doble';";
            $doblegente = $data->seleccionar($gentedoble);
            
            $gentekingsize = "SELECT T_HABITACION.CANTIDAD_MAX_ADULTOS as adultos, T_HABITACION.CANTIDAD_MAX_NINOS as niños
            from T_HABITACION
            where T_HABITACION.NOMBRE='King Size';";
            $kingsizegente = $data->seleccionar($gentekingsize);

            $gentesencilla = "SELECT T_HABITACION.CANTIDAD_MAX_ADULTOS as adultos, T_HABITACION.CANTIDAD_MAX_NINOS as niños
            from T_HABITACION
